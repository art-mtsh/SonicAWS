...
def three_distances(symbol, close, combined_list, max_avg_size, search_distance, market_type: str):
	...
	if size_1 >= max_avg_size and size_1_dollars >= avg_vol_60 and (price_1 <= min_of_range <= price_1 * 1.002 or price_1 * 0.998 <= max_of_range <= price_1):
	...
	if size_2 >= max_avg_size and size_2_dollars >= avg_vol_60 and (price_2 <= min_of_range <= price_2 * 1.002 or price_2 * 0.998 <= max_of_range <= price_2):
	...
	if size_3 >= max_avg_size and size_3_dollars >= avg_vol_60 and (price_3 <= min_of_range <= price_3 * 1.002 or price_3 * 0.998 <= max_of_range <= price_3):
